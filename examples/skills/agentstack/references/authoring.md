...
Only `SKILL.md` is required. The standard directories are optional; ordinary
visible files and directories are valid package content. Symlinks and other
special entries fail validation. Platform-specific adaptations belong under
`platform/`, not in the generic skill.
