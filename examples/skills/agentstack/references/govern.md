...
trail. Every action here changes what teammates see or install. Quote the
matching confirmation sentence and wait for explicit current-turn assent before
running it.
